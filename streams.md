...
:::{note}
"Тупые" боты без поддержки JavaScript не обрабатывают это перенаправление.
:::
...
* - совпадает с regex (без регистра)
...
* - не совпадает с regex (без регистра)
...
* - присвоить значение
  - Назначает параметру значение из аргумента.

* - переименовать в
  - Переименовывает параметр в аргумент.
