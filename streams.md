...
## Пробрасывать параметры на URL белой страницы
...
Допустим, ваша белая страница указана в виде ссылки:
```
...
Если посетитель будет посчитан опасным, то он будет перенаправлен на белую страницу с объединением параметров из обеих
ссылок выше:
```
