...
* - Черный
  - Посетитель будет заблокирован, если его IP-адрес или ASN находится в черном списке и отсутствует в белом. Белый список имеет приоритет над черным списком.

* - Белый
  - Посетитель будет заблокирован, если его IP-адрес или ASN находится в черном списке **или** отсутствует в белом. Черный список имеет приоритет над белым списком.

* - Специальный
  - Посетитель будет заблокирован, если его IP-адрес или ASN находится в черном списке. Если IP-адрес или ASN находится в белом списке, то посетитель будет сразу пропущен на контент в обход всех остальных проверок.
:::
