...
## Страны, операционные системы и браузеры

Эти настройки ручного таргетинга позволяют вам ограничить круг потенциальных посетителей контента только указанными
странами, операционными системами и браузерами. Обычно следует указывать те же таргетинги, что и в рекламной кампании.
