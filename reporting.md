...
У обеих таблиц есть кнопки "Скачать CSV" для скачивания отчетов в формате CSV, которые можно импортировать в Microsoft Excel,
Apple Numbers, Google Sheets и другие программы для работы с таблицами.

:::{tip}
Колонки таблиц можно менять местами, перетескивая их заголовки указателем мыши или пальцем на мобильном устройстве.
:::
