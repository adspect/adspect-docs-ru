...
качественного обслуживания, ориентированности на русскоязычных клиентов и отсутствия требования предоставления
личных данных.
...
1. [Создаете поток](streams.html) в Adspect и переводите его в режим «Модерация»;
...
6. Льете трафик и анализируете его показатели в разделе [«Статистика»](reporting.html).
