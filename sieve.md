...
:::{note}
Потоки облачного сервиса Adspect не используются в Adspect Sieve&trade;. Вам не нужно ничего настраивать в личном
кабинете Adspect, кроме приобретения подписки и получения ID аккаунта и ключа API для запуска Adspect Sieve&trade;.
:::
...
Для установки Adspect Sieve&trade; загрузите файл дистрибутива `adspectd_3.2_amd64.deb` на сервер и выполните
следующую команду от имени суперпользователя:

```bash
dpkg -i adspectd_3.2_amd64.deb
```
...
```text
[Information] Adspect Sieve software release 3.2
[Information] Copyright (C) 2019-2025 by Adspect
[Information] Authorizing for account ID: 1eb5991f-a25b-68f4-b171-00162501c2b4
[Information] Lease acquired through 2025-08-15 17:36:26
