...
:::{warning}
Не пытайтесь клоачить при помощи тарифа "Антифрод"! Он не содержит необходимых для клоакинга фильтров и баз данных, так что
вы лишь потеряете время, нервы и аккаунты.
:::
...
1. При создании потока выберите цель использования "Google Ads";
2. Белую страницу **необходимо** отображать без редиректа;
3. **Рекомендуется** отображать контент без редиректа;
4. Выполните [PHP-интеграцию](integration.md#php-integration).
