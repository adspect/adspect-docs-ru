...
3. Выполните [интеграцию любого типа](integration.html) в зависимости от ваших конкретных нужд.
   :::{important}
   При [PHP-интеграции](integration.md#php) убедитесь, что в настройках фильтрации снята галочка
   ["Включить фильтрацию по JavaScript-отпечаткам и обучение модели VLA™"](streams.md#javascript-vla).
   При [JS-интеграции](integration.md#javascript) вы можете включить ее.
   :::
...
3. Выполните [прямую PHP-интеграцию](integration.md#id2);
...
2. Используйте [PHP-интеграцию](integration.md#php);
...
2. Выполните [прямую PHP-интеграцию](integration.md#id2) путем размещения файла `index.php` на своем домене ---
