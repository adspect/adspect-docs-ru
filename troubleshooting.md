...
1. Указано действие "без действия", поэтому ничего не происходит. Установите корректное действие для страницы.
2. Вы пытаетесь отобразить файл интеграции `index.php` или страницу, в которую выполнена обратная PHP-интеграция,
...
1. Интеграция выполнена неправильно. Перепроверьте все шаги интеграции и убедитесь, что следуете инструкции дословно.
   В случае обратной PHP-интеграции перейдите на PHP-файл интеграции в браузере и убедитесь, что такой переход исправно
