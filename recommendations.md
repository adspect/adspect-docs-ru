...
14. **Не изменяйте** белые страницы в работающих кампаниях. Более строгие рекламные сети могут обнаружить даже
    незначительные изменения вроде добавления тэгов `<script>` и запустить процедуру проверки кампании или
